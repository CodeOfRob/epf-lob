#!/bin/bash
#SBATCH --job-name=HPO_LightGBMCPU  
#SBATCH --partition=paul,paula
#SBATCH --cpus-per-task=32
#SBATCH --mem=100G
#SBATCH --time=6:00:00
#SBATCH --output=$HOME/jobfiles/log/hpo/lgbm-cpu/%x_%j.out   
#SBATCH --error=$HOME/jobfiles/log/hpo/lgbm-cpu/%x_%j.error  
