#!/bin/bash
#SBATCH --job-name=HPO_logreg      
#SBATCH --cpus-per-task=32
#SBATCH --partition=paula,paul
#SBATCH --mem=100G
#SBATCH --time=10:00:00
#SBATCH --output=$HOME/jobfiles/log/hpo/logreg/%x_%j.out   
#SBATCH --error=$HOME/jobfiles/log/hpo/logreg/%x_%j.error  
