#!/bin/bash
#SBATCH --job-name=HPO_xgb_gpu       
#SBATCH --partition=paula,clara
#SBATCH --gpus=1
#SBATCH --cpus-per-task=16
#SBATCH --mem=60G
#SBATCH --time=6:00:00
#SBATCH --output=$HOME/jobfiles/log/hpo/xgb-gpu/%x_%j.out   
#SBATCH --error=$HOME/jobfiles/log/hpo/xgb-gpu/%x_%j.error  
...
module load CUDA/11.6.0  # xgb braucht CUDA
