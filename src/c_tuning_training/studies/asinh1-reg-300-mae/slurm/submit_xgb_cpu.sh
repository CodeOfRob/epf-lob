#!/bin/bash
#SBATCH --job-name=HPO_xgb_cpu      
#SBATCH --cpus-per-task=32
#SBATCH --partition=paula,paul
#SBATCH --mem=100G
#SBATCH --time=6:00:00
#SBATCH --output=$HOME/jobfiles/log/hpo/xgb_cpu/%x_%j.out   
#SBATCH --error=$HOME/jobfiles/log/hpo/xgb_cpu/%x_%j.error  
